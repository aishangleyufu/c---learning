...
namespace ItcastCater.Model
{
    ...
    {
        //select MemmberId,MemName,MemMobilePhone,MemAddress,MemType,MemNum,MemGender,MemDiscount
        //,MemMoney,DelFlag,SubTime,MemIntegral,MemEndServerTime,MemBirthdaty from MemmberInfo
        #region Model
